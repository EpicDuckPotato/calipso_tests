...
# TODO: add cones for control limits
h!(c, w, θ) = 0
hw!(J, w, θ) = 0
hθ!(J, w, θ) = 0
hw_sparsity = Vector{Tuple{Int64, Int64}}(undef, 0)
...
num_parameters = 0
solver = CALIPSO.Solver(methods, num_variables(transcription), num_parameters, num_equality(transcription), 0)
